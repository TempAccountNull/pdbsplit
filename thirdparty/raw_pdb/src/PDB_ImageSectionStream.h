...
namespace PDB
{
	...
	public:
		...
		// Converts an RVA into a one-based section offset.
		PDB_NO_DISCARD bool ConvertRVAToSectionOffset(uint32_t rva, uint16_t& oneBasedSectionIndex, uint32_t& offsetInSection) const PDB_NO_EXCEPT;
